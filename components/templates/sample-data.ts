...
export const sampleServiceBEO: ServiceBEOData = {
  ...
  timeline: [
    { time: '3:00 PM', label: 'Venue Access', sublabel: 'Setup begins', type: 'setup', notes: 'All vendors must check in at loading dock' },
    { time: '4:00 PM', label: 'Staff Arrival', sublabel: 'Team briefing', type: 'setup', notes: 'Mandatory briefing in staff room' },
    { time: '5:00 PM', label: 'Doors Open', sublabel: 'Cocktail hour', type: 'service', notes: 'Bar opens, passed apps begin' },
    { time: '6:00 PM', label: 'Guests Seated', sublabel: 'Dinner service', type: 'service' },
    ...
    { time: '9:00 PM', label: 'Bar Last Call', type: 'service' },
    { time: '10:00 PM', label: 'Last Dance', sublabel: 'Event concludes', type: 'service' },
    { time: '11:00 PM', label: 'Breakdown', sublabel: 'Load out', type: 'breakdown' },
  ],
  floorPlan: {
    totalTables: 16,
    totalSeats: 170,
    layout: '15 rounds of 10, head table of 20, cocktail area with lounge seating',
    specialArrangements: [
      'Head table elevated on platform',
      'Table 1 has 2 wheelchair-accessible seats on aisle',
      'Table 7 allergen-alert — special service protocol',
      'Table 12 kids table — early service at 6:45 PM',
      'Dance floor opens after dessert service',
    ],
  },
  staffPositioning: [
    {
    ...
    },
    {
      ...
      responsibilities: [
        ...
        'Table assignments provided at briefing — each server covers 15 guests',
        'Course delivery and tray service',
      ],
      members: [
    ...
    },
    {
      ...
      responsibilities: [
        'Full bar service',
        'Main bar (2 bartenders), Service bar (1 bartender)',
  ...
  guestManagement: {
    ...
    cocktailHour: true,
    seatingStyle: 'plated' as const,
    specialNeeds: [
      { tableNumber: '7', requirement: '2 guests with severe nut allergies — allergen-safe plating required', priority: 'critical' as const },
      { tableNumber: '1', requirement: '2 wheelchair-accessible seats required on aisle', priority: 'important' as const },
      { tableNumber: '12', requirement: 'Kids table — early meal service at 6:45 PM', priority: 'important' as const },
      { tableNumber: 'Head Table', requirement: 'Bride is pescatarian — salmon only. VIP priority service.', priority: 'important' as const },
    ],
  },
  serviceFlow: [
    { time: '5:00 PM', step: 'Cocktail Hour Opens', details: 'Guests arrive in cocktail area. Passed appetizers begin. Bar opens.', staffInvolved: ['Event Captain', 'Servers (cocktail)', 'Bartenders'], duration: '60 min' },
    { time: '6:00 PM', step: 'Escort to Dining Room', details: 'Guests directed to dining room via east entrance. Servers at station positions.', staffInvolved: ['Floor Captains', 'All Servers'], duration: '15 min' },
    { time: '6:15 PM', step: 'First Course Service', details: 'Appetizers plated and delivered. Head table served first.', staffInvolved: ['All Servers', 'Bussers'], duration: '30 min' },
    { time: '7:00 PM', step: 'Main Course Service', details: 'Clear first course. Deliver mains. Confirm dietary restrictions at Table 7.', staffInvolved: ['All Servers', 'Bussers', 'Floor Captains'], duration: '60 min' },
    { time: '8:00 PM', step: 'Dessert & Cake Service', details: 'Clear mains. Cake cutting ceremony. Dessert plated and served.', staffInvolved: ['All Servers', 'Event Captain'], duration: '45 min' },
    { time: '10:00 PM', step: 'Last Dance & Wind Down', details: 'Final bar service. Begin soft breakdown of non-essential areas.', staffInvolved: ['Bartenders', 'Bussers'], duration: '60 min' },
  ],
  equipmentSetup: [
    {
      ...
      items: [
        ...
        { item: 'Rectangular Tables (8ft)', quantity: 2, setupTime: '3:00 PM', notes: 'Head table' },
        { item: 'Cocktail Tables (36")', quantity: 8, setupTime: '3:30 PM' },
        { item: 'Chiavari Chairs - Gold', quantity: 160, setupTime: '3:00 PM' },
      ],
    },
    {
      ...
      items: [
        ...
        { item: 'Gold Charger Plates', quantity: 160, notes: 'Rental' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { item: 'Uplighting Units', quantity: 16, setupTime: '2:00 PM', notes: 'AV vendor' },
        { item: 'Wireless Microphones', quantity: 2, notes: 'Sound check at 4:30 PM' },
      ],
    },
  ],
  emergencyContacts: [
    { name: 'Victoria Whitmore', role: 'Client / Bride', phone: '(555) 123-4567', onSite: true },
    { name: 'David Chen', role: 'Co-Client / Groom', phone: '(555) 234-5678', onSite: true },
    { name: 'Sarah Martinez', role: 'Event Captain', phone: '(555) 345-6789', onSite: true },
    { name: 'Venue Manager', role: 'Venue Emergency', phone: '(555) 456-7890', onSite: true },
  ],
  vendorCoordination: [
    { vendorName: 'Elegant Blooms Florist', contact: 'Linda Kim (555) 111-2222', arrivalTime: '4:00 PM', setupArea: 'Main Dining Room — all tables', requirements: ['Access to service elevator', 'Needs 30 min setup time'], pointOfContact: 'Sarah Martinez' },
    { vendorName: 'SoundWave AV', contact: 'Mike Stevens (555) 222-3333', arrivalTime: '2:00 PM', setupArea: 'Perimeter uplighting + head table mics', requirements: ['Power access to perimeter', 'Sound check at 4:30 PM'], pointOfContact: 'Sarah Martinez' },
    { vendorName: 'Premier Party Rentals', contact: 'Tom Bradley (555) 333-4444', arrivalTime: '2:30 PM', setupArea: 'All dining tables', requirements: ['Charger plates and specialty linens delivery', 'Pickup next day by 10 AM'], pointOfContact: 'Venue Manager' },
    { vendorName: 'Memories Photography', contact: 'Jessica Park (555) 444-5555', arrivalTime: '4:30 PM', setupArea: 'All areas including kitchen access', requirements: ['Access to all event areas', 'Brief kitchen access during cocktail hour'], pointOfContact: 'Victoria Whitmore' },
  ],
...
COMMUNICATION: All staff equipped with earpieces. Ch1: Floor captains. Ch2: Kitchen. Ch3: Bar.`,
};
